...
class OrderedCode {
 public:
  ...
  static void WriteNumIncreasing(string* dest, uint64_t num);
  ...
  static bool ReadNumIncreasing(StringPiece* src, uint64_t* result);
 ...
 private:
  ...
  OrderedCode();
  DISALLOW_COPY_AND_ASSIGN(OrderedCode);
};
