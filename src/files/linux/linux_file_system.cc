...
base::error::Code ErrnoToCode(int err_number) {
  ...
  switch (err_number) {
    ...
    case ESPIPE:        // Invalid seek
      code = base::error::INVALID_ARGUMENT;
      break;
    case ETIMEDOUT:  // Connection timed out
    case ETIME:      // Timer expired
      code = base::error::DEADLINE_EXCEEDED;
      break;
    case ENODEV:  // No such device
    case ENOENT:  // No such file or directory
    case ENXIO:   // No such device or address
    case ESRCH:   // No such process
      code = base::error::NOT_FOUND;
      break;
    case EEXIST:         // File exists
    case EADDRNOTAVAIL:  // Address not available
    case EALREADY:       // Connection already in progress
      code = base::error::ALREADY_EXISTS;
      break;
    case EPERM:   // Operation not permitted
    case EACCES:  // Permission denied
    case EROFS:   // Read only file system
      code = base::error::PERMISSION_DENIED;
      break;
    ...
    case ETXTBSY:     // Text file busy
      code = base::error::FAILED_PRECONDITION;
      break;
    ...
    case EUSERS:   // Too many users
      code = base::error::RESOURCE_EXHAUSTED;
      break;
    case EFBIG:      // File too large
    case EOVERFLOW:  // Value too large to be stored in data type
    case ERANGE:     // Result too large
      code = base::error::OUT_OF_RANGE;
      break;
...
#endif
      code = base::error::UNAVAILABLE;
      break;
    case EDEADLK:  // Resource deadlock avoided
    case ESTALE:   // Stale file handle
      code = base::error::ABORTED;
      break;
    case ECANCELED:  // Operation cancelled
      code = base::error::CANCELLED;
      break;
  ...
  Status Read(uint64_t offset, size_t n, StringPiece* result,
    ...
    while (n > 0 && s.ok()) {
      ...
      if (r > 0) {
        ...
        s = Status(base::error::OUT_OF_RANGE, "Read less bytes than requested");
